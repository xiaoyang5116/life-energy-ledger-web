...
本目录用于沉淀产品、设计与工程实现相关文档。原始长篇 PRD 适合作为完整背景材料，仓库内文档则按用途拆分，方便开发时快速定位。

## 推荐阅读顺序

1. [产品整理稿](./product/prd-v1.2-summary.md)
2. [术语与命名规范](./product/terminology.md)
...
| 文档                             | 用途                                                     |
| -------------------------------- | -------------------------------------------------------- |
| `product/prd-v1.2-summary.md`    | 说明产品定位、核心哲学、用户场景和差异化                 |
| `product/terminology.md`         | 统一产品术语、用户可见命名、代码命名和禁用表达           |
